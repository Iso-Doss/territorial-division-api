                ...
                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                    ...
                    <p style="font-size: 14px; line-height: 160%; text-align: left;">
                        ...
                        <span style="font-size: 18px; line-height: 29px;">
                            ...
                            {{ __('Nous vous remercions d\'avoir créé votre compte sur') }}
            ...
            <tr>
                ...
                <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Oakes Grotesk',sans-serif;"
                    ...
                    <div align="center">
                        ...
                        {{-- <a href="{{ route('auth.validate-account', ['email' => $user->email, 'profile' => $user->profile, 'token' => $data['token']]) }}"--}}
                        <a href="{{ $data['validate_account_url'] . '/' . $user->email . '/' .  $user->profile . '/' .  $data['token'] }}"
                           target="_blank"

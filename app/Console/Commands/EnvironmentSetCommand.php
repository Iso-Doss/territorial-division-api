...
class EnvironmentSetCommand extends Command
{
    ...
    public function handle(): void
    {
        try {
            ...
            // Use a system env file path if the argument env file path is not provided.
     ...
     * This function returns the original "key=value" string and doesn't modify it.
     *
     * @param string $envFileContent
     * @param string $key
     *
     * @return string|null Key=value string or null if the key does not exist.
     */
